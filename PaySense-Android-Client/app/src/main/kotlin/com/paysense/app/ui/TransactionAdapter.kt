...
class TransactionAdapter(
    ...
    private val categoryIconMap = mapOf(
        "Food"          to R.drawable.ic_fastfood,
        "Food & Dining" to R.drawable.ic_fastfood,
        "Travel"        to R.drawable.ic_directions_car,
        "Shopping"      to R.drawable.ic_shopping_bag,
        "Bills"         to R.drawable.ic_receipt,
        "Utilities"     to R.drawable.ic_bolt,
        "Recharge"      to R.drawable.ic_smartphone,
        "Entertainment" to R.drawable.ic_movie,
        "Healthcare"    to R.drawable.ic_local_hospital,
        "Education"     to R.drawable.ic_school,
        "Grocery"       to R.drawable.ic_local_grocery_store,
        "Insurance"     to R.drawable.ic_shield,
        "P2P Transfer"  to R.drawable.ic_person,
        "EMI"           to R.drawable.ic_calendar_month,
        "Misc"          to R.drawable.ic_more_horiz,
        "Uncategorized" to R.drawable.ic_help_outline,
    )
