...
deployed operating threshold ($\tau=0.40$). An honest calibration analysis
identifies a recall ceiling of 69.96\% and proposes Platt Scaling as the
principal future improvement. The complete system is released as
open-source code.
\end{abstract}
...
\begin{figure}[H]
    ...
    \caption{
        ...
        curve plateaus at 69.96\% at $\tau = 0.05$, revealing the
...
\textbf{Probability calibration.} The 69.96\% recall ceiling identified in
...
69.96\% and diagnosed its root cause as probability miscalibration, with
